...
export PATH="$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$HOME/bin:$HOME/.config/composer/vendor/bin:$HOME/.bin:$HOME/.gem/ruby/2.4.0/bin:$HOME/.local/bin:$PATH"
...
# Wayland specific (Jetbrains IDE Fix)
...
# Alias
alias yarnpub='yarn electron:publish'
alias ls='colorls'
